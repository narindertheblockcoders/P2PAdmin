...
export default function OldStaking() {
  ...
  const { write: write } = useContractWrite({
    mode: "args",
    address: "0x5f157adbcc161a98e8366e8188d4ce55c2e34f43",
  ...
  async function getStakeData() {
    try {
      console.log("running")
      let res = await axios.post("/api/oldData");
  ...
  console.log(totalData, "total data here");
